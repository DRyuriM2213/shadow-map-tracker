...
function PersonagensPage() {
  ...
  return <Shell><div className="mx-auto max-w-6xl space-y-6">
    <header className="dossier rounded-sm p-5"><p className="stamp text-primary">Elenco atual da campanha</p><h1 className="text-3xl font-semibold">{PLAYERS.length} personagens de jogador</h1><p className="mt-1 text-sm text-muted-foreground">O painel apresenta contexto e registra fatos, mas nunca escolhe fala, sentimento ou ação por nenhum PJ.</p></header>
    <section className="dossier rounded-sm border-l-2 border-l-route-amarelo p-4 text-sm"><p className="stamp text-route-amarelo">Mudança de elenco</p><p className="mt-2 text-muted-foreground"><b>Percy não é mais personagem de jogador.</b> Andy saiu da campanha. Percy agora é <b>NPC controlado pelo mestre</b> e reaparece no início da invasão noturna para se juntar a Sofia, Adolfo, Jade e Vitor Hugo. Histórico, conhecimentos e missão secreta foram preservados, mas passam a ser material do mestre — consulte a ficha dele em <b>NPCs</b>. Se ainda existir um perfil multiplayer de Percy, ele não deve ser tratado como player ativo.</p></section>
