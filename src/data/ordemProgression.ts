...
export const MILESTONES: MilestoneDef[] = [
  ...
  milestone("m-treino-35", 35, "TREINAMENTO", "Grau de treinamento · 35%", "Melhore perícias que já estão Treinadas para Veteranas. Este marco não concede perícias novas."),
  milestone("m-treino-70", 70, "TREINAMENTO", "Grau de treinamento · 70%", "Melhore perícias já treinadas em um grau. Expert (+15) passa a estar disponível; este marco não concede perícias novas."),
